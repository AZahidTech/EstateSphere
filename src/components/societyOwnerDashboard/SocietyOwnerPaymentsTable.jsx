...
const cols = "1.2fr 1.5fr 1fr 1fr 1fr 0.5fr";

const SocietyOwnerPaymentsTable = () => (
    <div className="bg-white rounded-2xl p-5 border border-[#e9ecf3] flex-1">
        <div className="dash-section-header">
            <h2 className="text-[16px] font-bold text-[#1e2535]">Recent Collections</h2>
        ...
        <div>
            <div className="dash-table-head border-[#e9ecf3] text-[#7b8399]" style={{ gridTemplateColumns: cols }}>
                <span>TXN ID</span><span>RESIDENT</span><span>UNIT</span><span>TYPE</span><span>AMOUNT</span><span></span>
            </div>
            {payments.map((p, i) => (
                <div key={i} className="dash-table-row border-[#e9ecf3]" style={{ gridTemplateColumns: cols }}>
                    ...
                    <span className="text-[13.5px] text-[#1e2535]">{p.resident}</span>
                    <span className="text-[13.5px] text-[#1e2535]">{p.unit}</span>
