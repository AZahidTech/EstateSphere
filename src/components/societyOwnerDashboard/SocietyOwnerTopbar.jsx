...
const SocietyOwnerTopbar = () => (
    <header className="flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-10">
        <div className="flex flex-col">
            <h1 className="text-xl font-bold text-slate-900">Welcome Back, Usman Sheikh! 👋</h1>
        ...
        <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 w-[320px] focus-within:bg-white focus-within:ring-4 focus-within:ring-indigo-600/5 focus-within:border-indigo-600/20 transition-all duration-200 shadow-xs">
                <SearchIcon className="text-slate-400" />
                <input
                    className="bg-transparent border-none outline-none text-[14px] text-slate-900 placeholder:text-slate-400 w-full"
                    placeholder="Search for notifications, files..."
                />
            </div>
...
export default SocietyOwnerTopbar;
